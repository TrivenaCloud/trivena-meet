...
def execute():
	meetings = trivena.get_all("Sae Meeting", fields=["name", "members", "waiting_room"])
	...
	for meeting in meetings:
		try:
			...
			trivena.log_error(f"Error migrating meeting {meeting.name}: {e}")
			continue
